...
export default {
	...
	theme: {
		fontFamily: {
			...
			'sand-medium': ['NeueHaasDisplay-Medium', ...defaultTheme.fontFamily.sans],
		...
		extend: {
			...
			backgroundImage: {
				'starwar-gradient-light': 'linear-gradient(to bottom, #e6e6e6, transparent)',
				'starwar-gradient-dark': 'linear-gradient(to bottom, #000, transparent)',
				'404-gradient-light':
			...
			dropShadow: {
				...
				'404-dark': ['0px 0px 60px rgba(20, 20, 20, 0.8)', '0px 0px 100px rgba(20, 20, 20, 0.5)']
			}
		}
	},
	plugins: []
