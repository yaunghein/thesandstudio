<script lang="ts">
  ...
  let { role = "assistant", content = `In the context of our company, "The Sand Studio" is a creative agency crafted by talented individuals from around the globe, based in Bangkok. We offer a wide range of design, development, and consultation services.\n\nIf you\'re inquiring about the material "sand," it commonly refers to granular material composed of finely divided rock and mineral particles, typically found on beaches and deserts.\n\nHow else may I assist you today?` }: Props = $props();
...
<div class="flex items-start gap-4">
  <div
    class="shrink-0 w-[2.13rem] aspect-square text-black dark:text-light-100"
  >
    {#if isAI}
      <svg
        width="100%"
  ...
  <div class="flex flex-col pt-1">
    <div
      class={twm(
        isAI
          ? "text-sand-green dark:text-sand-green"
          : "text-black dark:text-light-100",
        "text-xl font-sand-bold mb-[2px]",
      )}
    >
      {isAI ? "Schat" : "You"}
    </div>
