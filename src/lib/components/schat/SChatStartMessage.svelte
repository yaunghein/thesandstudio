...
<div class="flex items-start gap-4">
	...
	<div class="flex flex-col pt-1">
		<div class="mb-[2px] font-sand-bold text-xl text-sand-green dark:text-sand-green">Schat</div>
		<p class="text-xl">
			Welcome to our virtual assistant! Please note that this chat is recorded for quality assurance
			and service improvement purposes. By continuing, you consent to the recording and use of your
			interactions as outlined in our
			<button onclick={() => dispatch('policyClick')} class="underline"> Privacy Policy </button>.
		</p>
	</div>
</div>
