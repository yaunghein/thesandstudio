...
<div
  use:drag
  use:position
  class="absolute z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40rem] rounded-3xl text-light-10 dark:text-light-100 bg-light-100 dark:bg-light-10 border-3 border-light-80 dark:border-light-40 overflow-hidden"
...
>
  ...
  <div
    class="rounded-3xl -m-[0.1875rem] border-3 border-light-80 dark:border-light-40 overflow-hidden"
  >
    {#if mediaType === "img"}
