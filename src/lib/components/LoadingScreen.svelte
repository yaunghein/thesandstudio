...
<div class="group">
  <button
    ...
    class={twm(
      ...
      "loading_logo-container aspect-square invert-0 fixed z-[54] left-1/2 -translate-x-1/2 sand-transition",
    )}
  >
    ...
    <div
      class={twm(
        ...
        "loading_logo-mouth  absolute inset-0 w-full h-full",
      )}
    >
      <div
    ...
    <div class="absolute inset-0 w-full h-full">
      ...
      >
        <div
          class={twm(show ? "opacity-0" : "opacity-100", "loading_logo-eyes ")}
        >
          <svg
            width="100%"
            height="100%"
