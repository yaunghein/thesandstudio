  ...
  <div class="h-full bg-white dark:bg-black w-full">
    <div class="h-full relative">
      ...
      <div class="p-4 h-full relative overflow-scroll hide-scrollbar">
        <div class="font-sand-mobile-bold text-5xl leading-[0.7] mb-3">
          Terms and Conditions
        </div>

        <div class="leading-[0.7] text-[1.375rem] w-full">
          <div class="flex flex-col gap-6">
            <p>
              Welcome to SAND! These Terms and Conditions ("Terms") govern the
              use of our services, which encompass a diverse range of innovative
              solutions including architecture, design, motion graphics, web
              development, and more. By engaging with our services, you agree to
              these Terms, so read them carefully. If you're into breaking the
              norm and exploring the new, you're in the right place. Let's get
              to it.
            </p>

            <div>
              <div class="text-3xl font-sand-mobile-bold leading-[0.7] mb-4">
                1. Definitions
              </div>
              <ul class="list-disc pl-[1.85rem] flex flex-col gap-4">
                <li>
                  "Company": Refers to SAND, where we do all sorts of incredible
                  things.
                </li>
                <li>
                  "Client": The individual, group, or entity that contracts our
                  services.
                </li>
                <li>
                  Services": The scope of work we provide, which can range from
                  visual identity to web development and architectural design.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul class="list-disc pl-[1.85rem] flex flex-col gap-4">
                <li>
                  ...
                  <ul class="list-circle mt-4 pl-[1.85rem] flex flex-col gap-4">
            ...
            <div>
              ...
              <ul class="list-disc pl-[1.85rem] flex flex-col gap-4">
                ...
                <li>
                  We do reserve the right to showcase our work for marketing and
                  portfolio purposes, unless we agree otherwise in writing.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul class="list-disc pl-[1.85rem] flex flex-col gap-4">
                <li>
                  If your use of our services leads to legal trouble, you're on
                  the hook. You agree to indemnify and hold us harmless against
                  any claims, damages, or losses arising from the use of our
                  work.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul class="list-disc pl-[1.85rem] flex flex-col gap-4">
                <li>
                  We take your privacy seriously. We collect and use client data
                  according to our Privacy Policy, which you can find on our
                  website.
                </li>
                <li>
                  Make sure any personal or sensitive data you give us complies
