  ...
  <div class="h-full bg-white dark:bg-black w-full">
    <div class="h-full relative">
      ...
      <div class="p-4 h-full relative overflow-scroll hide-scrollbar">
        ...
        <div
          id="about-tldr"
          class="relative z-10 flex flex-col gap-0 pointer-events-none mb-5"
        >
          <span class="leading-[0.75] text-2xl">TL;DR:</span>
          <span class="leading-[0.75] text-2xl">Small Team.</span>
          <span class="leading-[0.75] text-2xl">Big Ideas.</span>
        </div>
        <div class="relative text-2xl leading-[0.75] mb-5">
        ...
        <div class="relative text-2xl leading-[0.75] mb-5">
          ...
          and Code. We are the home for the curious, the thinkers, the makers,
          and the doers who are passionate about transforming bold ideas into
          tangible realities.
        </div>
        <div class="relative text-2xl leading-[0.75] mb-5">
        ...
        <div class="relative text-2xl leading-[0.75] mb-5">
          We are on a journey to a destination unknown, driven by the belief
        ...
        <div class="relative text-2xl leading-[0.75] mb-0">
