<script lang="ts">
	...
	const openTermsAndConditions = () => {
		...
		setTimeout(() => {
			const el = document.getElementById('Terms-&-Conditions') as HTMLButtonElement
			el.click()
		}, 0)
	}
...
{#if isOpen}
	<div
		...
		class="fixed right-16 top-[8.125rem] overflow-hidden rounded-3xl border-2 border-white p-6 pt-4 dark:border-light-12"
	>
		<div class="transparent-layer"></div>

		<div class="absolute inset-0 -ml-[0.5rem] flex gap-10 opacity-sand">
		...
		<div class="relative">
			...
			<div class="grid grid-cols-2 gap-5">
				...
				<a
					...
					class="sand-transition group relative grid aspect-square w-48 select-none place-items-center overflow-hidden rounded-3xl border-2 border-white p-2 text-light-100 hover:border-black dark:border-light-12 dark:hover:border-white"
				>
					<div
						class="sand-transition absolute inset-0 bg-light-90 group-hover:bg-black dark:bg-black dark:group-hover:bg-white"
					></div>

					<div
						class="sand-transition absolute left-1/2 top-10 w-10 -translate-x-1/2 invert group-hover:invert-0 dark:invert-0 dark:group-hover:invert"
					>
						<div class="sand-transition animate-spin-slow">
							<LogoShape />
						</div>
					</div>
					<div
						class="sand-transition absolute bottom-3 left-4 w-20 origin-right text-left font-sand-medium text-2xl leading-[1] text-black group-hover:text-light-100 dark:text-light-100 dark:group-hover:text-light-10"
					>
						SAND DESKTOP
					</div>
				</a>
				...
				>
					...
					<div
						class="sand-transition absolute left-1/2 top-[50%] w-32 -translate-x-1/2 -translate-y-[50%] scale-[1.4] invert group-hover:invert-0 dark:invert-0 dark:group-hover:invert"
					>
						<div
				...
				>
					...
					<div
						class="sand-transition absolute left-[50%] top-[50%] w-32 -translate-x-1/2 -translate-y-[50%] scale-[1.4] invert group-hover:-translate-x-[40%] group-hover:-translate-y-[90%] group-hover:rotate-[75deg] group-hover:scale-[2.3] group-hover:invert-0 dark:invert-0 dark:group-hover:invert"
					>
						<div
				...
				>
					...
					<div
						class="sand-transition absolute left-[50%] top-[50%] w-32 -translate-x-1/2 -translate-y-[50%] rotate-[180deg] scale-[1] invert group-hover:-translate-x-[0%] group-hover:-translate-y-[90%] group-hover:scale-[1.6] group-hover:invert-0 dark:invert-0 dark:group-hover:invert"
					>
						<img
					...
					<div
						class="sand-transition absolute bottom-3 left-4 origin-right translate-y-[100%] text-left font-sand-medium text-2xl text-light-100 opacity-0 group-hover:translate-y-[0%] group-hover:leading-[1] group-hover:opacity-100 dark:group-hover:text-light-10"
					>
						Not Works
					</div>
				</a>
			...
			<div class="mt-8 grid gap-8 px-[0.6rem] text-2xl text-light-80 dark:text-light-20">
				<div class="flex flex-col gap-2">
					<button
						class="sand-transition text-left leading-none hover:text-black dark:hover:text-white"
						onclick={() => {
				...
				<div class="flex flex-col gap-2">
					<a
						class="sand-transition leading-none hover:text-black dark:hover:text-white"
				...
				<div class="flex flex-col gap-2">
					<a class="sand-transition leading-none hover:text-black dark:hover:text-white" href="/">
						Made by The Sand Studio {new Date().getFullYear()}
					</a>
				</div>
			</div>

			<div class="mb-4 mt-8 flex w-[16rem] items-center px-[0.6rem] text-white">
				<svg
					width="100%"
					height="100%"
					viewBox="0 0 256 74"
