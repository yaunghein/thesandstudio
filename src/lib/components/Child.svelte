...
<div
	...
	class="fixed left-1/2 top-1/2 z-50 aspect-square w-[71rem] -translate-x-1/2 -translate-y-1/2 mix-blend-multiply"
>
	<!-- <div class="w-full h-full bg-sand-blue"></div> -->

	<div class="flex aspect-square w-full items-center">
		<svg
			width="100%"
			height="100%"
		...
		>
			...
			<defs>
				...
				>
					...
					<feComposite in2="SourceAlpha" operator="in" result="effect1_backgroundBlur_375_91" />
					<feBlend
						mode="normal"
						in="SourceGraphic"
	...
	<div
		class="sand-transition absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-5 text-center text-white"
	>
		<div class="max-w-[35rem] font-sand-medium text-6xl">the prodigal child* will return</div>
		<div class="max-w-[20rem] text-2xl">
			art, design, refined garments and contemporary culture.
		</div>
	</div>

	<div class="pointer-events-auto absolute right-24 top-[17.5rem]">
